// class ImageAyahUtils {
//  SuraAyah? getAyahFromKey(String key){
//     var parts = key.split(":");
//     var correctNumberOfParts = parts.length == 2;
//     int? sura = (correctNumberOfParts) ? int.tryParse(parts[0]) : null;
//     var ayah =  (correctNumberOfParts) ? int.tryParse(parts[1]) : null;
//     if (sura != null && ayah != null) {
//      return SuraAyah(sura, ayah) ;
//     } else {
//      return null ;
//     }
//   }

//    getAyahFromCoordinates(coords: Map<String, List<AyahBounds>>?,
